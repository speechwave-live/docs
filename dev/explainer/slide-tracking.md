...
<div class="code-block"><span class="label">adapters/index.js</span><pre>
...
<div class="collapsible">
  ...
  <div class="collapsible-body">
    ...
    <div class="code-block"><span class="label">adapters/google_slides.js</span><pre>
...
<div class="code-block"><span class="label">content.js</span><pre>
function checkSlide() {
