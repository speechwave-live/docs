...
1. Create a talk in the dashboard.
2. Connect the Chrome extension using your talk's API key and slug.
3. Share the QR code with your audience.
4. Present — reactions appear on your slides as they come in, and every reaction is recorded so you can review analytics after the talk is over.

## Next step

Ready to set up your first talk? Head to [Getting started](getting-started.html).
